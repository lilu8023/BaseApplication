...
import com.lilu.base.updata.proxy.IFileEncryptor;
...
import com.lilu.base.updata.proxy.impl.DefaultUpdateChecker;
import com.lilu.base.updata.proxy.impl.DefaultUpdateDownloader;
import com.lilu.base.updata.proxy.impl.DefaultUpdateParser;
import com.lilu.base.updata.proxy.impl.DefaultUpdatePrompter;
...
public class VersionUpdate {
     ...
     * @return
     */
    public VersionUpdate param(@NonNull String key, @NonNull Object value) {
        if (mParams == null) {
            mParams = new TreeMap<>();
        }
        Logger.d("设置全局参数, key:" + key + ", value:" + value.toString());
     ...
     * @return
     */
    public VersionUpdate params(@NonNull Map<String, Object> params) {
        logForParams(params);
        mParams = params;
        return this;
    }
     ...
     * @return
     */
    public VersionUpdate isGet(boolean isGet) {
        Logger.d("设置全局是否使用的是Get请求:" + isGet);
        mIsGet = isGet;
        return this;
    }
     ...
     * @return
     */
    public VersionUpdate isWifiOnly(boolean isWifiOnly) {
        Logger.d("设置全局是否只在wifi下进行版本更新检查:" + isWifiOnly);
     ...
     * @return
     */
    public VersionUpdate isAutoMode(boolean isAutoMode) {
        Logger.d("设置全局是否是自动版本更新模式:" + isAutoMode);
     ...
     * @return
     */
    public VersionUpdate setIFileEncryptor(IFileEncryptor fileEncryptor) {
