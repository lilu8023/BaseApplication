...
package com.lilu.base.updata.service;
...
import com.lilu.base.updata.VersionUpdate;
...
import com.lilu.base.updata.utils.ApkInstallUtils;
import com.lilu.base.updata.utils.UpdateUtils;
import com.lilu.base.utils.FileUtils;
...
import static com.lilu.base.updata.entity.UpdateError.ERROR.DOWNLOAD_FAILED;
...
public class DownloadService extends Service {
    ...
    public static void bindService(ServiceConnection connection) {
        Intent intent = new Intent(VersionUpdate.getContext(), DownloadService.class);
        VersionUpdate.getContext().startService(intent);
        VersionUpdate.getContext().bindService(intent, connection, Context.BIND_AUTO_CREATE);
        mIsRunning = true;
    }
...
//            channel.setVibrationPattern(new long[]{100, 200, 300, 400, 500, 400, 300, 200, 400});
    ...
    private NotificationCompat.Builder getNotificationBuilder() {
        return new NotificationCompat.Builder(this, CHANNEL_ID)
                .setContentTitle(getString(R.string.lab_start_download))
                .setContentText(getString(R.string.connecting_service))
                .setOngoing(true)
                .setAutoCancel(true)
    ...
    private void startDownload(@NonNull UpdateEntity updateEntity, @NonNull FileDownloadCallBack fileDownloadCallBack) {
        ...
        if (TextUtils.isEmpty(apkUrl)) {
            String contentText = getString(R.string.tip_download_url_error);
            stop(contentText);
            return;
        }
        ...
        Logger.d("开始下载更新文件, 下载地址:" + apkUrl + ", 保存路径:" + target + ", 文件名:" + apkName);
    ...
    private class FileDownloadCallBack implements IUpdateHttpService.DownloadCallback {
        ...
        public void onProgress(float progress, long total) {
            ...
            if (mOldRate != rate) {
                ...
                if (mBuilder != null) {
                    mBuilder.setContentTitle(getString(R.string.lab_downloading) + UpdateUtils.getAppName(DownloadService.this))
                            .setContentText(rate + "%")
        ...
        public void onSuccess(File file) {
            ...
            Logger.d("更新文件下载完成, 文件路径:" + file.getAbsolutePath());
            try {
                if (UpdateUtils.isAppOnForeground(DownloadService.this)) {
                    ...
                    if (mIsAutoInstall) {
                        VersionHelper.startInstallApk(DownloadService.this, file, mDownloadEntity);
                    } else {
        ...
        public void onError(Throwable throwable) {
            ...
            VersionHelper.onUpdateError(DOWNLOAD_FAILED, throwable.getMessage());
            //App前台运行
            if (mOnFileDownloadListener != null) {
    ...
    private void showDownloadCompleteNotification(File file) {
        ...
        mBuilder.setContentIntent(contentIntent)
                ...
                .setContentText(getString(R.string.lab_download_complete))
