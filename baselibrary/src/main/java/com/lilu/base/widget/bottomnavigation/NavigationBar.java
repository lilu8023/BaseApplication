package com.lilu.base.widget.bottomnavigation;
...
import com.lilu.base.widget.CustomViewPager;
...
//    private Techniques anim = null;
    ...
    private void initViews(Context context, AttributeSet attrs) {
        ...
        contentView = (RelativeLayout) View.inflate(context, R.layout.layout_navigation, null);
    ...
    private void parseStyle(TypedArray attributes) {
        if (attributes != null) {
            //要放在前面
            textSizeType = attributes.getInt(R.styleable.NavigationBar_textSizeType, textSizeType);


            msgPointColor = attributes.getColor(R.styleable.NavigationBar_msgPointColor, msgPointColor);
            ...
            msgPointMoreWidth = attributes.getDimension(R.styleable.NavigationBar_msgPointMoreWidth, msgPointMoreWidth);
            msgPointMoreHeight = attributes.getDimension(R.styleable.NavigationBar_msgPointMoreHeight, msgPointMoreHeight);
            msgPointMoreRadius = attributes.getInt(R.styleable.NavigationBar_msgPointMoreRadius, msgPointMoreRadius);
            tabTextSize = NavigationBarUtil.compareTo(getContext(), attributes.getDimension(R.styleable.NavigationBar_tabTextSize, 0), tabTextSize, textSizeType);
            tabTextTop = attributes.getDimension(R.styleable.NavigationBar_tabTextTop, tabTextTop);
            iconSize = (int) attributes.getDimension(R.styleable.NavigationBar_tabIconSize, iconSize);
            hintPointSize = attributes.getDimension(R.styleable.NavigationBar_hintPointSize, hintPointSize);
            msgPointSize = attributes.getDimension(R.styleable.NavigationBar_msgPointSize, msgPointSize);
            hintPointLeft = attributes.getDimension(R.styleable.NavigationBar_hintPointLeft, hintPointLeft);
            msgPointTop = attributes.getDimension(R.styleable.NavigationBar_msgPointTop, -iconSize * 3 / 5);
            hintPointTop = attributes.getDimension(R.styleable.NavigationBar_hintPointTop, hintPointTop);

            msgPointLeft = attributes.getDimension(R.styleable.NavigationBar_msgPointLeft, -iconSize / 2);
            msgPointTextSize = NavigationBarUtil.compareTo(getContext(),attributes.getDimension(R.styleable.NavigationBar_msgPointTextSize, 0),msgPointTextSize,textSizeType);
            centerIconSize = attributes.getDimension(R.styleable.NavigationBar_centerIconSize, centerIconSize);
            centerLayoutBottomMargin = attributes.getDimension(R.styleable.NavigationBar_centerLayoutBottomMargin, centerLayoutBottomMargin);

            //加号属性
            centerSelectTextColor = attributes.getColor(R.styleable.NavigationBar_centerSelectTextColor, centerSelectTextColor);
            centerNormalTextColor = attributes.getColor(R.styleable.NavigationBar_centerNormalTextColor, centerNormalTextColor);
            centerTextSize = NavigationBarUtil.compareTo(getContext(), attributes.getDimension(R.styleable.NavigationBar_centerTextSize, 0), centerTextSize, textSizeType);
            centerTextTopMargin = attributes.getDimension(R.styleable.NavigationBar_centerTextTopMargin, centerTextTopMargin);
            centerAlignBottom = attributes.getBoolean(R.styleable.NavigationBar_centerAlignBottom, centerAlignBottom);


            lineHeight = attributes.getDimension(R.styleable.NavigationBar_lineHeight, lineHeight);
            lineColor = attributes.getColor(R.styleable.NavigationBar_lineColor, lineColor);


            centerLayoutHeight = attributes.getDimension(R.styleable.NavigationBar_centerLayoutHeight, navigationHeight + lineHeight);

            normalTextColor = attributes.getColor(R.styleable.NavigationBar_tabNormalColor, normalTextColor);
            selectTextColor = attributes.getColor(R.styleable.NavigationBar_tabSelectColor, selectTextColor);

            int type = attributes.getInt(R.styleable.NavigationBar_scaleType, 0);
            if (type == 0) {
            ...
            centerLayoutRule = attributes.getInt(R.styleable.NavigationBar_centerLayoutRule, centerLayoutRule);
            hasPadding = attributes.getBoolean(R.styleable.NavigationBar_hasPadding, hasPadding);

            centerAsFragment = attributes.getBoolean(R.styleable.NavigationBar_centerAsFragment, centerAsFragment);
            attributes.recycle();
        }
    }


    public NavigationBar setupWithViewPager(@NonNull ViewPager viewPager) {
...
//若没有设置中间添加的文字字体大小、颜色、则同其他Tab一样
     ...
     * 重置各个参数
     */
    public NavigationBar defaultSetting() {
...
//        anim = null;
        ...
        smoothScroll = false;
        //图标大小
        iconSize = NavigationBarUtil.dip2px(getContext(), 20);

        //提示红点大小
        hintPointSize = NavigationBarUtil.sp2px(getContext(), 6);
        //提示红点距Tab图标右侧的距离
        hintPointLeft = NavigationBarUtil.dip2px(getContext(), -3);
        //提示红点距图标顶部的距离
        hintPointTop = NavigationBarUtil.dip2px(getContext(), -3);

        //消息红点字体大小
        msgPointTextSize =11;
        //消息红点大小
        msgPointSize = NavigationBarUtil.dip2px(getContext(), 18);
        //消息红点距Tab图标右侧的距离   默认为Tab图标的一半
        msgPointLeft = NavigationBarUtil.dip2px(getContext(), -10);
        //消息红点距图标顶部的距离  默认为Tab图标的一半
        msgPointTop = NavigationBarUtil.dip2px(getContext(), -12);
        //Tab文字距Tab图标的距离
        tabTextTop = NavigationBarUtil.dip2px(getContext(), 2);
        //Tab文字大小
        tabTextSize = 12;
        //未选中Tab字体颜色
        ...
        navigationHeight = NavigationBarUtil.dip2px(getContext(), 60);

        scaleType = ImageView.ScaleType.CENTER_INSIDE;

        canScroll = false;

        centerIconSize = NavigationBarUtil.dip2px(getContext(), 36);
        centerLayoutHeight = navigationHeight;
        centerLayoutBottomMargin = NavigationBarUtil.dip2px(getContext(), 10);
        ...
        //加号文字距离顶部加号的距离
        centerTextTopMargin = NavigationBarUtil.dip2px(getContext(), 3);
        //是否和其他tab文字底部对齐
        ...
        //消息红点99+的长度
        msgPointMoreWidth = NavigationBarUtil.dip2px(getContext(), 30);
        //消息红点99+的高度
        msgPointMoreHeight = NavigationBarUtil.dip2px(getContext(), 18);
        //消息红点99+的半径
    ...
    public NavigationBar centerImageRes(int centerImageRes) {
    ...
    public NavigationBar centerTextStr(String centerTextStr) {
    ...
    private void setViewPagerAdapter() {
        if (mViewPager == null) {
            ...
            mViewPager.setId(R.id.tag_viewpager);
            contentView.addView(mViewPager, 0);
        }
        adapter = new ViewPagerAdapter(fragmentManager, BEHAVIOR_SET_USER_VISIBLE_HINT, fragmentList);
    ...
    private void addTabItemView(final int position) {
        View itemView = View.inflate(getContext(), R.layout.item_navigation, null);
        ...
        NavigationBarUtil.setOvalBg(hintPoint, msgPointColor);
        ...
        msgPointParams.bottomMargin = (int) NavigationBarUtil.dip2px(getContext(), -12);
    ...
    private void addCenterTabCustomView(int i) {
        ...
        final RelativeLayout.LayoutParams linearParams = new RelativeLayout.LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT, ViewGroup.LayoutParams.WRAP_CONTENT);
        //linearParams.width = NavigationBarUtil.getScreenWidth(getContext()) / tabCount;
...
//                    YoYo.with(anim).duration(300).playOn(tabList.get(i));
    ...
    public void setMsgPointCount(int position, int count) {
        ...
        if (count > 99) {
            NavigationBarUtil.setRoundRectBg(getContext(), msgPointView, (int) msgPointMoreRadius, msgPointColor);
            ...
            msgPointView.setLayoutParams(params);
            NavigationBarUtil.setOvalBg(msgPointView, msgPointColor);
    ...
    public NavigationBar centerLayoutHeight(int centerLayoutHeight) {
        this.centerLayoutHeight = NavigationBarUtil.dip2px(getContext(), centerLayoutHeight);
        return this;
    }
    ...
    public NavigationBar centerIconSize(int centerIconSize) {
        this.centerIconSize = NavigationBarUtil.dip2px(getContext(), centerIconSize);
        return this;
    }
    ...
    public NavigationBar navigationHeight(int navigationHeight) {
        this.navigationHeight = NavigationBarUtil.dip2px(getContext(), navigationHeight);
        return this;
    }
    ...
    public NavigationBar tabTextTop(int tabTextTop) {
        this.tabTextTop = NavigationBarUtil.dip2px(getContext(), tabTextTop);
        return this;
    }
    ...
    public NavigationBar msgPointSize(int msgPointSize) {
        this.msgPointSize = NavigationBarUtil.dip2px(getContext(), msgPointSize);
        return this;
    }

    public NavigationBar msgPointLeft(int msgPointLeft) {
        this.msgPointLeft = NavigationBarUtil.dip2px(getContext(), msgPointLeft);
        return this;
    }

    public NavigationBar msgPointTop(int msgPointTop) {
        this.msgPointTop = NavigationBarUtil.dip2px(getContext(), msgPointTop);
        return this;
    }


    public NavigationBar hintPointSize(int hintPointSize) {
        this.hintPointSize = NavigationBarUtil.dip2px(getContext(), hintPointSize);
        return this;
    }

    public NavigationBar hintPointLeft(int hintPointLeft) {
        this.hintPointLeft = NavigationBarUtil.dip2px(getContext(), hintPointLeft);
        return this;
    }

    public NavigationBar hintPointTop(int hintPointTop) {
        this.hintPointTop = NavigationBarUtil.dip2px(getContext(), hintPointTop);
        return this;
    }


    public NavigationBar titleItems(String[] titleItems) {
        this.titleItems = titleItems;
        return this;
    }

    public NavigationBar normalIconItems(int[] normalIconItems) {
        this.normalIconItems = normalIconItems;
        return this;
    }

    public NavigationBar selectIconItems(int[] selectIconItems) {
...
//    }
    ...
    public NavigationBar centerLayoutRule(int centerLayoutRule) {
    ...
    public NavigationBar setOnCenterTabClickListener(OnCenterTabSelectListener onCenterTabClickListener) {
        this.onCenterTabClickListener = onCenterTabClickListener;
        return this;
    }

    public NavigationBar iconSize(int iconSize) {
        this.iconSize = NavigationBarUtil.dip2px(getContext(), iconSize);
        return this;
    }

    public NavigationBar centerLayoutBottomMargin(int centerLayoutBottomMargin) {
        this.centerLayoutBottomMargin = NavigationBarUtil.dip2px(getContext(), centerLayoutBottomMargin);
        return this;
    }

    public NavigationBar centerAsFragment(boolean centerAsFragment) {
    ...
    public NavigationBar centerTextSize(int centerTextSize) {
        this.centerTextSize = NavigationBarUtil.dip2px(getContext(), centerTextSize);
        return this;
    }

    public NavigationBar centerNormalTextColor(int centerNormalTextColor) {
        this.centerNormalTextColor = centerNormalTextColor;
        return this;
    }

    public NavigationBar centerSelectTextColor(int centerSelectTextColor) {
        this.centerSelectTextColor = centerSelectTextColor;
        return this;
    }

    public NavigationBar centerTextTopMargin(int centerTextTopMargin) {
        this.centerTextTopMargin = NavigationBarUtil.dip2px(getContext(), centerTextTopMargin);
        return this;
    }

    public NavigationBar centerAlignBottom(boolean centerAlignBottom) {
...
//    }
    ...
    public NavigationBar textSizeType(int textSizeType) {
    ...
    public NavigationBar setMsgPointMoreWidth(float msgPointMoreWidth) {
        this.msgPointMoreWidth = NavigationBarUtil.dip2px(getContext(), msgPointMoreWidth);
        return this;
    }
    ...
    public NavigationBar setMsgPointMoreHeight(float msgPointMoreHeight) {
        this.msgPointMoreHeight = NavigationBarUtil.dip2px(getContext(), msgPointMoreHeight);
        return this;
    }
    ...
    public NavigationBar setMsgPointMoreRadius(int msgPointMoreRadius) {
    ...
    public NavigationBar setMsgPointColor(int msgPointColor) {
        this.msgPointColor = msgPointColor;
        return this;
    }

    public NavigationBar setOnTabLoadListener(OnTabLoadListener onTabLoadListener) {
