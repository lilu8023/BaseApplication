...
package com.lilu.base.update.service;
...
import static com.lilu.base.update.entity.UpdateError.ERROR.DOWNLOAD_FAILED;
...
//            channel.setVibrationPattern(new long[]{100, 200, 300, 400, 500, 400, 300, 200, 400});
    ...
    private NotificationCompat.Builder getNotificationBuilder() {
        return new NotificationCompat.Builder(this, CHANNEL_ID)
                ...
                .setOngoing(true)
                .setAutoCancel(true)
                .setSmallIcon(R.drawable.ic_update_close)
