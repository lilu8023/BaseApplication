...
import static com.lilu.base.update.entity.UpdateError.ERROR.PROMPT_UNKNOWN;
...
public class UpdateDialogFragment extends DialogFragment implements View.OnClickListener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.layout_updata, container);
    }
    ...
    private void initTheme(@ColorInt int themeColor, @DrawableRes int topResId, @ColorInt int buttonTextColor) {
        if (themeColor == -1) {
            themeColor = ColorUtils.getColor(getContext(), R.color.color_E94339);
        }
        if (topResId == -1) {
    ...
    private void onInstallApk() {
        VersionHelper.startInstallApk(getContext(), UpdateUtils.getApkFileByUpdateEntity(mUpdateEntity), mUpdateEntity.getDownLoadEntity());
    }

    private void onInstallApk(File apkFile) {
        VersionHelper.startInstallApk(getContext(), apkFile, mUpdateEntity.getDownLoadEntity());
    }
    ...
    public void show(FragmentManager manager, String tag) {
        ...
        try {
            ...
            VersionHelper.onUpdateError(PROMPT_UNKNOWN, e.getMessage());
        }
    }
