...
package com.lilu.base.updata.utils;
...
import static com.lilu.base.updata.entity.UpdateError.ERROR.CHECK_APK_CACHE_DIR_EMPTY;
import static com.lilu.base.updata.entity.UpdateError.ERROR.CHECK_IGNORED_VERSION;
...
public final class UpdateUtils {
    ...
    public static void processUpdateEntity(UpdateEntity updateEntity, @NonNull String result, @NonNull IUpdateProxy updateProxy) throws Exception {
        if (updateEntity != null) {
            ...
            VersionHelper.onUpdateError(CHECK_PARSE, "json:" + result);
        }
    }
    ...
    public static boolean checkWifi() {
        ConnectivityManager connectivity = (ConnectivityManager) VersionUpdate.getContext().getSystemService(Context.CONNECTIVITY_SERVICE);
    ...
    public static boolean isApkDownloaded(UpdateEntity updateEntity) {
        ...
        return !TextUtils.isEmpty(updateEntity.getMd5())
                ...
                && VersionHelper.isFileValid(updateEntity.getMd5(), appFile);
    }
    ...
    public static boolean isPrivateApkCacheDir(@NonNull UpdateEntity updateEntity) {
        return FileUtils.isPrivatePath(VersionUpdate.getContext(), updateEntity.getApkCacheDir());
    }
    ...
    public static String getDefaultDiskCacheDirPath() {
        return UpdateUtils.getDiskCacheDir(VersionUpdate.getContext(), KEY_XUPDATE);
    }
