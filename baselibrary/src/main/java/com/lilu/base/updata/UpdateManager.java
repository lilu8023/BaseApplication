...
import static com.lilu.base.updata.entity.UpdateError.ERROR.CHECK_NO_NETWORK;
import static com.lilu.base.updata.entity.UpdateError.ERROR.CHECK_NO_WIFI;
import static com.lilu.base.updata.entity.UpdateError.ERROR.PROMPT_ACTIVITY_DESTROY;
...
public class UpdateManager implements IUpdateProxy {
    ...
    private void doUpdate() {
        ...
        if (mIsWifiOnly) {
            if (UpdateUtils.checkWifi()) {
                ...
                onAfterCheck();
                VersionHelper.onUpdateError(CHECK_NO_WIFI);
            }
        } else {
            if (UpdateUtils.checkNetwork()) {
                ...
                onAfterCheck();
                VersionHelper.onUpdateError(CHECK_NO_NETWORK);
            }
        }
    }
    ...
    public static class Builder {
        ...
        Builder(@NonNull Context context) {
            ...
            params = new TreeMap<>();
            if (VersionHelper.getParams() != null) {
                params.putAll(VersionHelper.getParams());
            }
            ...
            isGet = VersionHelper.isGet();
            isWifiOnly = VersionHelper.isWifiOnly();
            isAutoMode = VersionHelper.isAutoMode();
